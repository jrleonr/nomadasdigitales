...
<div class="relative px-6 lg:px-8">
    <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-40 sm:pb-40">
        <div>
            <div class="hidden sm:mb-3 sm:flex sm:justify-center">
                <div class="relative overflow-hidden py-1.5 px-4 text-md leading-6">
                    <span class="text-gray-600">
                        Para negocios que buscan freelancers o agencias
                    </span>
                </div>
            </div>
            <div>
                ...
                <p class="mt-3 flex text-sm text-gray-500 sm:justify-center">
                    Completamente gratuito. No necesita registro.
                </p>
            </div>
            <div
    ...
    <div class="mx-auto max-w-4xl px-6 py-24 sm:py-32 lg:max-w-7xl lg:px-8 lg:py-40">
        ...
        <div class="mt-20 grid grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-semibold leading-8 text-white">Responde cómodamente</h3>
                    <p class="mt-2 text-base leading-7 text-indigo-200">Recibe las propuestas donde tú elijas, en tu
                        email o compartiendo una dirección que sea cómoda para ti. No necesitas entrar a esta web para
                        nada.</p>
                </div>
            </div>
